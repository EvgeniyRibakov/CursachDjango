...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "newsletters/static",  # Путь к статическим файлам в приложении newsletters
]
...
PASSWORD_RESET_TIMEOUT = 86400  # 1 день в секундах (замена для PASSWORD_RESET_TIMEOUT_DAYS)
